...
urlpatterns = [
    ...
    path('dictionaries/<int:pk>/export/', TWFDictionaryDictionaryExportView.as_view(), name='dictionaries_export'),
    ...
    path('project/collections/<int:pk>/', TWFProjectCollectionsDetailView.as_view(), name='project_collections_view'),
