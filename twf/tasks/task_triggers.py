...
def start_dictionaries_batch_unified(request):
    ...
    return trigger_ai_task(request, search_ai_entries,
                          dictionary_id=dictionary_id,
...
def start_documents_batch_unified(request):
    ...
    return trigger_ai_task(request, search_ai_for_docs,
                          ai_provider=provider,
                          model=model,
...
def start_collections_batch_unified(request):
    ...
    return trigger_ai_task(request, search_ai_for_collection,
...
def start_collections_request_unified(request):
    ...
    return trigger_ai_task(request, search_ai_for_collection_item,
                          item_id=item_id,
                          ai_provider=provider,
                          model=model)
...
def start_query_project_unified(request):
    ...
    return trigger_ai_task(request, query_project_unified,
                          ai_provider=provider,
                          model=model,
                          documents=documents)
