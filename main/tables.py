...
class DocumentTable(tables.Table):
    ...
    options = tables.TemplateColumn(template_name='main/document_table_options.html', verbose_name="Options", attrs={"td": {"width": "10%"}})
...
class DictionaryEntryTable(tables.Table):
    ...
    options = tables.TemplateColumn(template_name='main/dictionary_entry_table_options.html', verbose_name="Options")
    ...
    def render_variations(self, record):
        ...
        for var in variations:
            html += record_html.format(reverse('main:delete_variation', args=[var.id]), var.variation)
