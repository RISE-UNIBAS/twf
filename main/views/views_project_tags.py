...
from main.forms import CreateDictionaryEntryForm, AssignToEntryForm
from main.models import PageTag, Dictionary, DictionaryEntry, Variation
...
class ProjectGroupTagsView(BaseProjectView, TemplateView):
    """View to assign tags to dictionary entries."""
    template_name = 'main/structure.html'
...
class ProjectParkedTagsView(BaseProjectView, TemplateView):
    ...
    template_name = 'main/parked.html'
